...
export default function DashboardPage() {
  ...
  const [favorites, setFavorites] = useState(() => {
    try {
      return JSON.parse(
        localStorage.getItem('starred_rooms') || '[]'
      );
    } catch (_) {
      return [];
    }
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        setActivity(
          actRes.data.data.logs || []
        );

        setPendingInvites(
          invRes.data.data.invitations || []
        );
      } catch (err) {
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              {[1, 2, 3, 4].map((i) => (
                <div
                  key={i}
                  className="card p-6 h-40 flex flex-col justify-between"
                >
            ...
            <div className="card p-16 text-center space-y-4">
              ...
              <div>
                ...
                <p className="text-surface-450 text-sm mt-1">
              ...
              {[...myRooms]
                ...
                .map((room) => {
                  ...
                  return (
                    <div
                      key={room._id}
                      className="card p-5 hover:border-primary-500/50 hover:shadow-lg transition-all group flex flex-col justify-between h-44"
                    >
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center gap-2 flex-shrink-0">
                            ...
                            <button
                              ...
                              className={`p-1 rounded-md transition-all hover:bg-surface-700 ${
                                isFav
                                  ? 'text-yellow-400'
                                  : 'text-surface-450 hover:text-yellow-400'
                              }`}
                            >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-start justify-between gap-2">
                      ...
                      >
                        ...
                        {deletingActivityId ===
                        log._id ? (
                          <span className="block w-3.5 h-3.5 border-2 border-surface-500 border-t-transparent rounded-full animate-spin" />
                        ) : (
                          <TbTrash
                            size={15}
                          />
